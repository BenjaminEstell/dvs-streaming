        ...
        loop {
            ...
            match event_type {
                ...
                EventTypes::EvtTimeHigh => {
                    ...
                    let mut new_time_base = (ev_time_high.timestamp() as u64) << 12;
                ...
                EventTypes::EvtTimeLow => {
                    let ev_time_low = RawEventTime::from(raw_event);
                    self.current_time_low = ev_time_low.timestamp();
